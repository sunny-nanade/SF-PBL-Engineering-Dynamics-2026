...
integration. {\color{blue} The primary objective of this study was to design, implement,
...
to computation {\color{blue} as commonly reported breakthrough moments.} Exhibition rubric scores
...
{\color{blue} offers a replicable, empirically-evaluated model for computationally-integrated}
...
{\color{blue} These gaps distinguish the present work from three established pedagogical
...
{\color{blue} pre-to-post learning gains ($d$\,$>$\,1.0) from a mixed-methods study
...
{\color{blue} Table~\ref{tab:synthesis} summarises the alignment between these theoretical
...
{\color{blue} In the NBA/OBE framework, Programme Outcome (PO) attainment is evidenced
...
$N$\,=\,53 applies throughout this paper. {\color{blue} As this is a single-cohort,
single-institution study, findings should be interpreted within this
...
{\color{blue} Because each of the six judges evaluated a distinct professional dimension
...
{\color{blue} Inter-rater consistency across the six expert domains was assessed using
...
{\color{blue} \subsection{Course Outcome Attainment (OBE)}
...
{\color{blue} All findings reported below are interpreted within the constraints of a
...
meta-analyses. {\color{blue} Three factors contextualise the magnitude of the present
...
{\color{blue} This pattern is consistent with the interpretation that the computational
...
{\color{blue} indicates meaningful score discrimination}: the 43-point range separates
...
{\color{blue} \subsection{The Breakthrough Theme: A Widely Observed Learning Landmark}}
...
size, {\color{blue} suggesting it may represent a \textbf{common learning landmark}} in
...
{\color{blue} designed to be domain-adaptable; its transferability to related subjects such
...
desirability bias; {\color{blue} while inter-rater composite reliability and rank
...
Future research should: {\color{blue} (1)~replicate the SF-PBL framework across multiple
...
{\color{blue} This study fulfilled its primary objective---to design, implement, and
...
{\color{blue} The SF-PBL framework offers a replicable, empirically-evaluated, and
